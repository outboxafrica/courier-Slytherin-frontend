      ...
      {isLoaded ? (
        <>
          <div className="pdleft">
            ...
            <img className="pdProductImg" src={product.image} alt="product" />
          </div>
...
const Right = () => {
  ...
  return (
    <div className="pdleftComp">
      <h1 className="pdLeftTitle">{product.title}</h1>
      <div className="pdLeftSect">
        <h1 className="pdleftPrice">UGX{product.price}</h1>
        <div className="pdLeftaddProduct">- 1 +</div>
      </div>
      <div className="pdleftDesc">{product.description}</div>
